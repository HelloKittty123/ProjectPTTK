 ...
 * @author Admin
 */
public class AppWareHouse extends javax.swing.JFrame {
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppWareHouse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new AppWareHouse().setVisible(true);
        });
    }
