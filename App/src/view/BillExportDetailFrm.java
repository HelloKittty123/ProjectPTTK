...
public class BillExportDetailFrm extends javax.swing.JDialog {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if(jtfIDProduct.getText().length() >= 0) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Bạn chưa nhập ID sản phẩm!");
            isOK = false;
        }
        ...
        if(isOK) {
            if(ProductController.findByIdProduct(idProduct)) {
                if(ProductController.findByCountProduct(idProduct, count)) {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Bạn đã thêm sản phẩm thành công");
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Số lượng sản phẩm còn lại trong kho khổng đủ");
                }
            } else {
                JOptionPane.showMessageDialog(rootPane, "ID sản phẩm không tồn tại");
            }
        }
