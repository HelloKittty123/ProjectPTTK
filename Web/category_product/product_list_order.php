<?php
	...
	if(!empty($_POST)) {
		...
		$sql = "insert into orders (user_id, fullname, phone_number, email, address, note, total, create_time, status) values ('$user_id', '$fullname', '$phone_number', '$email', '$address', '$note', '$total', '$create_time', 0)";
		execute($sql);
