	...
	<div class="service__page row" style = "margin: 80px 100px;">
		<div class="service__page-content col-md-9 col-12">
			<div class="page__intro">
				<p style="color:#b02b2c; font-weight: 500;">ABC Wedding – Cho thuê bàn ghế đám cưới , cho thuê bàn ghế sự kiện, hội nghị, bàn ghế chiavairi, bàn ghế banquet tiêu chuẩn khách sạn, bàn ghế xuân hòa… với nhiều mẫu mã từ bình dân đến cao cấp tiêu chuẩn khách sạn 5 sao tại các Quận Hà Nội như Đống Đa, Cầu Giấy, Hoàn Kiếm, Tây Hồ, Ba Đình.</p>
			</div>
			...
			echo '
				<li class="page__list-item row" style="margin: 30px 0">
					<div class="col-md-6 col-12">
						...
						<p>Giá tiền: <span style="color:#b02b2c; font-weight:500; margin-top: 20px;">'.number_format($item['price'],0,',','.').' VNĐ/1 bộ</span></p>
						<p>'.$item['description'].'</p>
					</div>
					<div class="item__thumbnail col-md-5 col-12">
						<img src="'.$item['thumbnail'].'" style="width:100%;" alt="Ảnh sản phẩm">
					</div>
				</li>
					';
	}
